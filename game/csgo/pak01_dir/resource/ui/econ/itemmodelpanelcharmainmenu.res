"resource/ui/econ/itemmodelpanelcharmainmenu.res"
{
	"mainmenu_player-model"
	{
		...
		"config"
		{
			...
			"root_mdl"					"characters/models/shared/animsets/animset_uiplayer.vmdl"
			"weapon_anim"				"default"
			"weapon_anim_loop"			"default"

			"camera_offset"   			"98 5.90 50.58"
			"camera_orient"   			"0.00 -180.00 0.00"
			"orbit_pivot"     			"-0.00 4.50 54.80"
			"root_camera_fov"     		"45.0"

			"item_rotate"				"y[-360 360]"

			"camera_preset_add"   "pos[98 3.3 50.58] pivot[-0.00 4.50 54.80] orient[0.00 -180.00 0.00]"
			"camera_preset_add"   "pos[98 3.3 50.58] pivot[-0.00 4.50 54.80] orient[0.00 -180.00 0.00]"
